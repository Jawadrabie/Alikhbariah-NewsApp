...
(
  ...
  'https://picsum.photos/seed/photo-1517048676732-d65bc937f952/1200/800',
...
(
  ...
  'https://picsum.photos/seed/photo-1551836022-d5d88e9218df/1200/800',
  (select id from public.categories where slug = 'news-politics' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1469474968028-56623f02e42e/1200/800',
  (select id from public.categories where slug = 'news-politics' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1450101499163-c8848c66ca85/1200/800',
  (select id from public.categories where slug = 'news-politics' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1494172961521-33799ddd43a5/1200/800',
  (select id from public.categories where slug = 'news-politics' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1556740749-887f6717d7e4/1200/800',
...
(
  ...
  'https://picsum.photos/seed/photo-1542838132-92c53300491e/1200/800',
  (select id from public.categories where slug = 'news-economy' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1581090700227-1e8e8f7aef35/1200/800',
  (select id from public.categories where slug = 'news-economy' limit 1),
  (select id from public.locations where slug = 'hama' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1498050108023-c5249f4df085/1200/800',
  (select id from public.categories where slug = 'news-economy' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1520607162513-77705c0f0d4a/1200/800',
  (select id from public.categories where slug = 'news-economy' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1477959858617-67f85cf4f1df/1200/800',
...
(
  ...
  'https://picsum.photos/seed/photo-1480714378408-67cf0d13bc1f/1200/800',
  (select id from public.categories where slug = 'news-local' limit 1),
  (select id from public.locations where slug = 'homs' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1497366754035-f200968a6e72/1200/800',
  (select id from public.categories where slug = 'news-local' limit 1),
  (select id from public.locations where slug = 'aleppo' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1479839672679-a46483c0e7c8/1200/800',
  (select id from public.categories where slug = 'news-local' limit 1),
  (select id from public.locations where slug = 'latakia' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1516483638261-f4dbaf036963/1200/800',
  (select id from public.categories where slug = 'news-local' limit 1),
  (select id from public.locations where slug = 'daraa' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1451187580459-43490279c0fa/1200/800',
...
(
  ...
  'https://picsum.photos/seed/photo-1473448912268-2022ce9509d8/1200/800',
  (select id from public.categories where slug = 'news-international' limit 1),
  (select id from public.locations where slug = 'tartus' limit 1),
  now() - interval '8 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1464037866556-6812c9d1c72e/1200/800',
  (select id from public.categories where slug = 'news-international' limit 1),
  (select id from public.locations where slug = 'aleppo' limit 1),
  now() - interval '11 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1501004318641-b39e6451bec6/1200/800',
  (select id from public.categories where slug = 'news-international' limit 1),
  (select id from public.locations where slug = 'hama' limit 1),
  now() - interval '14 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1473341304170-971dccb5ac1e/1200/800',
  (select id from public.categories where slug = 'news-international' limit 1),
  (select id from public.locations where slug = 'homs' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1461896836934-ffe607ba8211/1200/800',
...
(
  ...
  'https://picsum.photos/seed/photo-1579952363873-27f3bade9f55/1200/800',
  (select id from public.categories where slug = 'news-sports' limit 1),
  (select id from public.locations where slug = 'damascus' limit 1),
  now() - interval '9 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1517649763962-0c623066013b/1200/800',
  (select id from public.categories where slug = 'news-sports' limit 1),
  (select id from public.locations where slug = 'hama' limit 1),
  now() - interval '12 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1546519638-68e109498ffc/1200/800',
  (select id from public.categories where slug = 'news-sports' limit 1),
  (select id from public.locations where slug = 'latakia' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1431324155629-1a6deb1dec8d/1200/800',
  (select id from public.categories where slug = 'news-sports' limit 1),
  (select id from public.locations where slug = 'tartus' limit 1),
...
(
  ...
  'https://picsum.photos/seed/photo-1518998053901-5348d3961a04/1200/800',
...
(
  ...
  'https://picsum.photos/seed/photo-1512820790803-83ca734da794/1200/800',
  (select id from public.categories where slug = 'news-culture' limit 1),
  (select id from public.locations where slug = 'homs' limit 1),
  now() - interval '10 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1473445361085-b9a07f55608b/1200/800',
  (select id from public.categories where slug = 'news-culture' limit 1),
  (select id from public.locations where slug = 'aleppo' limit 1),
  now() - interval '13 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1491841550275-ad7854e35ca6/1200/800',
  (select id from public.categories where slug = 'news-culture' limit 1),
  (select id from public.locations where slug = 'latakia' limit 1),
  now() - interval '16 hours',
  false,
...
(
  ...
  'https://picsum.photos/seed/photo-1489599849927-2ee91cede3ba/1200/800',
  (select id from public.categories where slug = 'news-culture' limit 1),
  (select id from public.locations where slug = 'as-suwayda' limit 1),
...
values
  ('الأخبار السياسية', 'Political News Videos', 'video-political-news', 'https://picsum.photos/seed/photo-1495020689067-958852a7765e/1200/800', 1, 'video'),
  ('الاقتصاد والأسواق', 'Economy and Markets', 'video-economy-markets', 'https://picsum.photos/seed/photo-1611974714024-4607a55d4001/1200/800', 2, 'video'),
  ('محليات', 'Local Reports', 'video-local-reports', 'https://picsum.photos/seed/photo-1477959858617-67f85cf4f1df/1200/800', 3, 'video'),
  ('شؤون دولية', 'International Affairs', 'video-international-affairs', 'https://picsum.photos/seed/photo-1451187580459-43490279c0fa/1200/800', 4, 'video'),
  ('رياضة', 'Sports Videos', 'video-sports-news', 'https://picsum.photos/seed/photo-1461896836934-ffe607ba8211/1200/800', 5, 'video'),
  ('ثقافة ومجتمع', 'Culture and Society', 'video-culture-society', 'https://picsum.photos/seed/photo-1518998053901-5348d3961a04/1200/800', 6, 'video')
on conflict (slug) do update
set
  name = excluded.name,
  name_en = excluded.name_en,
...
insert into public.categories (name, name_en, slug, cover_image_url, order_index, type)
values
  ('نشرة التاسعة', 'Nine Oclock Bulletin', 'program-nine-bulletin', 'https://picsum.photos/seed/photo-1486406146926-c627a92ad1ab/1200/800', 1, 'program'),
  ('عين على الاقتصاد', 'Eye on Economy', 'program-eye-on-economy', 'https://picsum.photos/seed/photo-1554224155-6726b3ff858f/1200/800', 2, 'program'),
  ('المشهد السياسي', 'Political Scene', 'program-political-scene', 'https://picsum.photos/seed/photo-1504711434969-e33886168f5c/1200/800', 3, 'program'),
  ('ملف الأسبوع', 'Weekly File', 'program-weekly-file', 'https://picsum.photos/seed/photo-1450101499163-c8848c66ca85/1200/800', 4, 'program'),
  ('الشارع السوري', 'Syrian Street', 'program-syrian-street', 'https://picsum.photos/seed/photo-1480714378408-67cf0d13bc1f/1200/800', 5, 'program'),
  ('منصة الحوار', 'Dialogue Platform', 'program-dialogue-platform', 'https://picsum.photos/seed/photo-1517048676732-d65bc937f952/1200/800', 6, 'program')
on conflict (slug) do update
set
  name = excluded.name,
  name_en = excluded.name_en,
